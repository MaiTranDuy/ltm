...
int main() {
	...
	while (1) {
		...
		if (!isLoggedIn) {
			...
			FILE* f = fopen("C:\\Users\\duy01\\source\\repos\\Bai2_9-5-2022\\account.txt", "r");
			...
			strcat(buf, " > C:\\Users\\duy01\\source\\repos\\Bai2_9-5-2022\\output.txt");

			system(buf);

			send(client, "Success! See response at directory C:\\Users\\duy01\\source\\repos\\Bai2_9-5-2022\\output.txt\n", 47, 0);
		}
